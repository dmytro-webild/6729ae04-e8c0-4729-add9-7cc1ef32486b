...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          name: "Pierre Dubois",
          handle: "@fragrance_group",
          testimonial: "The authenticity and oil yield of Sai Vivek's Sandalwood have been unmatched in our formulations.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/middle-age-businessman-smiling-happy-standing-city_839833-25759.jpg",
        },
        {
          name: "Yuki Tanaka",
          handle: "@cosmetic_asia",
          testimonial: "A reliable partner providing high-grade materials with excellent documentation and logistics.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/glamorous-model-make-up-studio_23-2148328753.jpg",
        },
        {
          name: "Ahmed Al-Mansoori",
          handle: "@luxury_perfumes",
          testimonial: "Exceptional Agarwood chips. The provenance and quality are perfect for our high-end oud line.",
          rating: 5,
        ...
        },
        {
          name: "Elena Rossi",
          handle: "@artisan_oils",
          testimonial: "Professional, consistent, and deeply committed to sustainable sourcing. A premier export partner.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/world-science-day-research-innovation-elements_23-2151812338.jpg",
        },
        {
          name: "Marcus Weber",
          handle: "@luxury_incense",
          testimonial: "Truly aged woods. The scent profile of their sandalwood is exactly what our premium range demands.",
          rating: 5,
      ...
      buttons={[
        {
          text: "Request Premium Export Quote",
          href: "#contact",
        },
      ]}
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/blonde-business-woman-work_23-2149100301.jpg",
          alt: "User avatar",
        },
      ]}
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "We pride ourselves on providing aged, certified woods sourced from traditional Indian regions with meticulous attention to oil content and grade purity.",
        "Our exports are underpinned by rigorous authentication, ensuring that every shipment meets the stringent quality requirements of international perfume houses and luxury cosmetic manufacturers.",
        "Through long-term dedication to sustainable practices and government-backed sourcing, Sai Vivek Wood Exports remains the trusted source for high-end wood materials globally.",
      ]}
    />
  </div>
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Government Sourced",
          description: "Strict adherence to government regulations ensures total authenticity.",
          icon: ShieldCheck,
          mediaItems: [
            {
        ...
        {
          title: "Aged Quality",
          description: "45-60 years of natural aging for superior scent and oil profiles.",
          icon: Clock,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Secure, fast, and compliant shipping to Europe, UAE, and Asia.",
          icon: Truck,
          mediaItems: [
            {
              imageSrc: "http://img.b2bpic.net/free-photo/perfume-bottle-held-by-hand_23-2152010127.jpg",
            },
            {
              imageSrc: "http://img.b2bpic.net/free-photo/hand-showing-perforated-globe-shape-paper-green-nature-background_53876-47086.jpg",
            },
          ],
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=rpt7xr",
          imageAlt: "User provided image",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          company: "Tokyo Cosmetics",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/side-view-mature-woman-working-greenhouse_171337-5851.jpg",
        },
        {
          id: "t3",
          name: "Ahmed Al-Mansoori",
          role: "Lead Buyer",
          company: "Oud Emirates",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/small-business-manager-his-workshop_23-2149094573.jpg",
        },
        {
          id: "t4",
          name: "Elena Rossi",
        ...
        },
        {
          id: "t5",
          name: "Marcus Weber",
          role: "Principal Trader",
          company: "Global Incense",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/artisan-doing-woodcutting_23-2150600782.jpg",
        },
      ]}
      ...
      metrics={[
        {
          ...
          value: "45+",
          title: "Years Aged",
          description: "Average aging of our premium red sandalwood.",
          icon: Timer,
        },
        {
          id: "m2",
          value: "7%",
          title: "Peak Oil Content",
          description: "Ensuring highest purity for fragrance manufacturers.",
          icon: Droplet,
        },
        {
          id: "m3",
          ...
          description: "Extensive network across UAE, Europe, and Asia.",
          icon: Globe,
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Contact Our Export Team",
          href: "mailto:exports@saivivek.com",
        },
      ]}
    />
  </div>
      ...
      columns={[
        {
          ...
          items: [
            {
              label: "Red Sandalwood",
              href: "#products",
            },
            {
              label: "White Sandalwood",
              href: "#products",
            },
            {
              label: "Agarwood",
